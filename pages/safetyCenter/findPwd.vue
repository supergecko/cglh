<template>
	<view class="wrap">
		<view class="main">
			<view class="group">
				<text style="font-size: 34upx;color: #171719">+86</text>
				<input type="text" value="" placeholder="请输入手机号" style="text-indent: 1em;"/>
			</view>
			<view class="group">
			...
			<view class="group no">
				<input type="text" value="" placeholder="请输入账户登录密码"/>
			</view>
		</view>
